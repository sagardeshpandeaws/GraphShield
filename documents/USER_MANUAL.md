...
2. **Analyses findings** across **66 categories** — 26 Active Directory + 40 Azure/Entra ID
...
- **Finding Cards** (only groups you selected):
  ...
  - **40 Azure/Entra ID finding types** (AZ-001 through AZ-040) from BloodHound data
...
│   ├── finding_builder.py          ── 66 finding definitions (26 AD + 40 Azure)
...
│   ├── azure_queries.py            ── 41 Cypher queries (40 Azure/Entra ID findings + 1 supporting query)
